      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-pink-400 to-purple-500 rounded-full flex items-center justify-center shadow-lg">
          ...
          <div className="flex items-center justify-center space-x-3">
            ...
            <div className="w-32 bg-gray-200 rounded-full h-2">
              <div className="bg-gradient-to-r from-pink-400 to-purple-500 h-2 rounded-full w-3/4"></div>
            </div>
          </div>
        </div>
